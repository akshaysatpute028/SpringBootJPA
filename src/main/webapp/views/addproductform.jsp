...
<div class="row">
    <div class="col input-group">
      ...
      <input type="text" class="form-control" name="p_id" placeholder="Enter Product Id" required/>
    </div>
    <div class="col input-group">
...
<textarea name="p_description" class="form-control" rows="8" cols="30" placeholder="Description"></textarea><br>
